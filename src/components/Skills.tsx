...
import { Reveal, RevealHeading, RevealLine, RevealSlide, RevealStagger, staggerItem } from "./Reveal";
...
export default function Skills() {
  return (
    <section id="skills" className="section-pad border-t border-line">
      ...
      />
      <Reveal delay={0.1}>
        <p className="text-muted text-[1.02rem] leading-[1.7] max-w-[640px] font-light mb-2">
      ...
      <Reveal delay={0.15}>
        <p className="font-mono text-xs text-muted mb-8">Hover a card to flip it and see the full skill list.</p>
      </Reveal>
